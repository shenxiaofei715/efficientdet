...
flags.DEFINE_string('model_dir', "/home/lwp/anaconda3/envs/tf/automl/efficientdet/model/", 'Location of model_dir')
...
flags.DEFINE_string('hparams', "use_bfloat16=false",
...
flags.DEFINE_integer('eval_samples', 5000, 'The number of samples for '
                     'evaluation.')
flags.DEFINE_integer(
    'iterations_per_loop', 300, 'Number of iterations per TPU training loop')
flags.DEFINE_string(
    'training_file_pattern', "/home/lwp/anaconda3/envs/tf/automl/efficientdet/dataset/tfrecord/*.tfrecord",
    'Glob for training data files (e.g., COCO train - minival set)')
flags.DEFINE_string(
    'validation_file_pattern', "/home/lwp/anaconda3/envs/tf/automl/efficientdet/dataset/tfrecord/*.tfrecord",
...
flags.DEFINE_integer('num_examples_per_epoch', 266,
...
def main(argv):
  ...
  tpu_config = tf.estimator.tpu.TPUConfig(
      ...
      .PER_HOST_V2)
  #本地计算机也就是GPU/CPU上训练run_config=tf.estimator.tpu.RunConfig
  # (cluster=None,model_dir=训练ckpt模型保存的路径,log_step_count_steps保存模型频率,session_config=config_proto
  #设备显存分配, tpu_config=None)
